...
| **Developer / Operator**      | Maintains code, merges to `main`, which auto-deploys                                                     | Repository + CI/CD (see [technology/deployment.md](../technology/deployment.md)) |
...
This progression is exactly the [value stream](../strategy/value-stream.md);
