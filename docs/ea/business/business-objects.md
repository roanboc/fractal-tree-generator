...
are in [information/data-objects.md](../information/data-objects.md).
...
| **Fractal Rule**      | The recursive recipe that grows a shape — "draw a stick, branch, do it all again smaller"              | All creative services     | `FractalParams` (tree), `TurtleProgram` (snowflake & custom) |
...
| **Preset**            | A named, known Fractal Rule offered as a starting point (tree, snowflake, fern, crystal, spiral, bush) | Custom-rule authoring     | `PRESETS` list in `create.ts`                                |
