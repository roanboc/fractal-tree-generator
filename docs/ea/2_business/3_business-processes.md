...
the [business services](./2_business-services.md).
...
[Principle 5](../1_strategy/1_motivation.md#principles-principle).
...
Technology realization: [technology/2_deployment.md](../5_technology/2_deployment.md).
