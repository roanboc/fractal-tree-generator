...
[domain context & rules](../2_business/5_domain-context-and-rules.md#system-context)). It's stored
...
- The CLI path writes to **two** independent stores (SQLite and a JSON
  ...
  [../4_application/5_interface-contracts.md#iloggerservice](../4_application/5_interface-contracts.md#iloggerservice) for the
...
| Everything else in this system               | —                          | There is no user identity, no authentication, no analytics, no third-party data sharing. See [domain context & rules](../2_business/5_domain-context-and-rules.md#system-context) for the full system boundary.                                                 |
